...
public class Quiz extends JFrame implements ActionListener {
    ...
    String username;
        Quiz(String username){
            ...
            getContentPane().setBackground(new Color(55,66,253));
            setBounds(150,20,1240,800);
            setLayout(null);

            ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("com/apps/icons/quiz.jpg"));
            JLabel l1 = new JLabel(i1);
            l1.setBounds(0,0,1240,415);
            add(l1);

            qno = new JLabel("");
            qno.setBounds(70,450,200,30);
            ...
            question.setBounds(105, 450,900,30);
            ...
            lifeline.setBounds(1000,540,200,40);
            lifeline.setBackground(Color.CYAN);
            lifeline.setForeground(Color.BLACK);
            lifeline.addActionListener(this);
            add(lifeline);

            next = new JButton("Next");
            next.setBounds(1000,600,200,40);
            ...
            submit.setBounds(1000,660,200,40);
        ...
        public void actionPerformed(ActionEvent e){
            if(e.getSource() == next){
                ...
                if(options.getSelection() == null){
                    ...
                    ua[count][0] = options.getSelection().getActionCommand();
                }
                if(count == 8){
